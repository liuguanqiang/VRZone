...
namespace VRZoneLib.Classes.Utils
{
    ...
    {
        private static VZ_AppHelper singleton = null;
        ...
        public static VZ_AppHelper getSingleton()
        {
            if(singleton == null)
            {
                singleton = new VZ_AppHelper();
            }
            return singleton;
        }
        ...
        public void getServerInfo()
        {
            try
            {
                ...
                url = url + "?from=vrzone&id=" + systemInfo.computerId + "&sid=iloveyouvrzone&tm="+tm+"&uid=1&sign=" + VZ_UpdateMethods.strToMD5(sign).ToUpper();
        ...
        public static String getQRCodeAddres()
        {
            ...
            String sign = "from=vrzone&deviceid=" + VZ_AppHelper.getSingleton().systemInfo.computerId + "&sid=iloveyouvrzone&tm=" + tm + "&uid=1&--iloveyouvrzone";
            sign = VZ_UpdateMethods.strToMD5(sign).ToUpper();
            url += "from=vrzone&deviceid=" + VZ_AppHelper.getSingleton().systemInfo.computerId + "&sid=iloveyouvrzone&tm=" + tm + "&uid=1&sign=" + sign;
            return url;
        }
        ...
        public static String getQRCodeURL()
        {
            ...
            sign = VZ_UpdateMethods.strToMD5(sign).ToUpper();
            url += "from=vrzone&id=" + VZ_AppHelper.getSingleton().systemInfo.computerId + "&sid=iloveyouvrzone&tm=" + tm + "&uid=1&sign=" + sign;
            return url;
        }
        ...
        public static String getQRCodeURL(int index)
        {
            ...
            String sign = "from=vrzone&id=" + VZ_AppHelper.getSingleton().systemInfo.computerId + "&sid=iloveyouvrzone&sonid=" + (index + 1) + "&tm=" + tm + "&uid=1&--iloveyouvrzone";
            sign = VZ_UpdateMethods.strToMD5(sign).ToUpper();
            url += "from=vrzone&id=" + VZ_AppHelper.getSingleton().systemInfo.computerId + "&sid=iloveyouvrzone&sonid=" + (index + 1) + "&tm=" + tm + "&uid=1&sign=" + sign;
            return url;
        }
        #endregion
    }
